          ...
          <div className="z-50 flex items-center justify-center">
            ...
            <div className="text-sm">
              <div className="relative flex flex-col items-center p-6 leading-relaxed text-white bg-black border border-opacity-25 bg-opacity-40 border-slate-300 rounded-xl">
                Turborepo Web with: <span className="text-base font-bold underline underline-offset-2">tailwindcss</span> & <span className="text-base font-bold underline underline-offset-2">shadcn/ui</span> pre-configured.
